%
% sorted_data = sort_data_1014(in_data,N,names)
% 
...
% the old matrix.
%
% Output is to be used with get_data_1014.m. It is a struct of the 
...
function sorted_data = sort_data_1014(in_data,N,names)
  ...
  if any(true_dup_N) 
      ...
      for a = 1:max(num_dup_N)
          ...
          sorted_data.dup_weight10{a} = in_data(ind,15)';
          sorted_data.dup_weight14{a} = in_data(ind,16)';

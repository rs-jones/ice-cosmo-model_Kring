%
% add_names_concs1014(norm_sample_data)
%
% Adds sample names to a two-isotope plot (14C/10Be vs 10Be).
%
% norm_sample_data is a required struct, initially created using get_data_1014.m
% with concentrations normalised in plot_concs_1014.m.
%
...
function add_names_concs1014(norm_sample_data)
  ...
  if nnz(norm_sample_data.logical_10) ~= nnz(norm_sample_data.logical_14)
      ...
      for a = 1:length(norm_sample_data.s)
          ...
          ratio(a) = this_sample.norm_N14/N10(a);
      end

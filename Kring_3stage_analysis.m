...
%
% Uses the floating parameters of time exposed and time buried (in years), 
% to compute a three-stage (exposure-burial-exposure) history.
%
...
best_fits = fit_3stage_1014(sample_data,model_time_bnds,bur_dur_bnds,n_iterations,model_interval,fig_h,burial_frac_bnds);


% Plot bestfit concentrations
close;
fig_bf = plot_bestfit_3stage_1014(sample_data,best_fits,model_interval,expo_intervals,bur_intervals,x_lim,y_lim);


% Export bestfit results
save_name = 'MtKring_3stage_n1000'; % Specify file name
